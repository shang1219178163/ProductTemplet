...
- (void)viewDidLoad {
    ...
    self.carArray = [[DBManager shared] getAllCarsFromPerson:self.person];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete){
        ...
        [[DBManager shared] deleteCar:car fromPerson:self.person];
        self.carArray = [[DBManager shared] getAllCarsFromPerson:self.person];
...
- (void)addCar{
    ...
    [[DBManager shared] addCar:car toPerson:self.person];
    self.carArray = [[DBManager shared] getAllCarsFromPerson:self.person];
