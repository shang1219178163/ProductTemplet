...
@property (nonatomic, strong) NSTimer *fallTimer;
...
- (void)viewDidLoad{
    ...
    // 动画定时器
    _fallTimer = [NSTimer scheduledTimerWithTimeInterval:0.8 target:self selector:@selector(fallAction) userInfo:nil repeats:YES];
}
