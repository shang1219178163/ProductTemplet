...
#import "NNUploadImagesController.h"
#import <Photos/Photos.h>
#import <MobileCoreServices/MobileCoreServices.h>
#import "TZImagePickerController.h"
#import "TZImageUploadOperation.h"

@interface NNUploadImagesController ()<TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate> {
...
@implementation NNUploadImagesController
...
- (void)viewDidLoad {
    ...
    _allowPickingGif = true;
    _allowPickingOriginalPhoto = true;
    _allowPickingVideo = true;
    _allowPickingMuitlpleVideo = true;

    _showSheet = true;
    _maxCount = 1;
    _columnNumber = 4;
    _allowCrop = true;
    _needCircleCrop = true;
...
- (void)pushTZImagePickerController {
    if (self.maxCount <= 0) {
        [self showAlertTitle:nil message:@"选择" actionTitles:@[@"知道了"] handler: nil];
        return;
    }
