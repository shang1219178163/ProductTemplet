...
#import "UITableViewCycleViewCell.h"
#import <NNGloble/NNGloble.h>

@implementation UITableViewCycleViewCell
...
-(NNCycleView *)cycleView{
    if (!_cycleView) {
        _cycleView = ({
            NNCycleView * view = [[NNCycleView alloc]initWithFrame:CGRectMake(kX_GAP, kY_GAP + 100, kScreenWidth - kX_GAP*2, 60)];
