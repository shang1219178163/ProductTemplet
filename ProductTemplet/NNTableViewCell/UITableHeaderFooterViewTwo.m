...
-(void)layoutSubviews{
    ...
    CGSize btnSize = [self.btn sizeThatFits:CGSizeMake(0, btnH)];
    self.btn.frame = CGRectMake(CGRectGetWidth(self.contentView.frame) - kX_GAP - btnSize.width,
                                CGRectGetMidY(self.imgViewLeft.frame) - btnH/2.0,
                                btnSize.width,
                                btnSize.height);
}
