...
-(void)layoutSubviews{
    ...
    if (self.labelLeft.attributedText.length > 0) {
    ...
    if (self.labelLeftSub.attributedText.length > 0) {
...
-(UILabel *)labelLeftPrefix{
    if (!_labelLeftPrefix) {
        _labelLeftPrefix = [UILabel createRect:CGRectZero type:NNLabelTypeFitWidth];
    }
