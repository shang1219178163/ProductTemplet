...
-(void)layoutSubviews{
    ...
    if (self.imgViewLeft.image) {
        ...
        //控件4
        CGRect imgViewRightRect = CGRectMake(self.contentView.sizeWidth - imgViewRightSize.width -  kX_GAP, CGRectGetMidY(imgViewLeftRect) - imgViewRightSize.height/2.0, imgViewRightSize.width, imgViewRightSize.height);
        //控件3
        ...
        //控件4
        CGRect arrowRect = CGRectMake(self.contentView.sizeWidth - arrowSize.width -  kX_GAP, CGRectGetMidY(self.contentView.frame) - arrowSize.height/2.0, arrowSize.width, arrowSize.height);
        //控件3
