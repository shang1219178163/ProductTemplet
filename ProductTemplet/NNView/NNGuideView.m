...
@interface NNGuideView ()<UIScrollViewDelegate>
        ...
        if (i == self.images.count - 1) {
            ...
            if (!self.isScrollOut) {
                ...
                for (NSInteger i = 0; i < 2; i++) {
                    ...
                    CGRect btnRect = CGRectMake(btnPadding + (btnWith + btnPadding)*i,
                                                CGRectGetHeight(self.scrollView.frame) * 0.8,
                                                btnWith,
                                                btnHeight);
                    
                    UIButton *btn = [UIButton createRect:btnRect title:btnTitleArr[i] type:NNButtonTypeTitleTheme];
                    btn.tag = kTAG_BTN+i;
                    btn.titleLabel.font = [UIFont systemFontOfSize:kFontSize16];
...
-(void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    NSInteger cuttentIndex = (NSInteger)(scrollView.contentOffset.x + self.sizeWidth/2)/self.sizeWidth;
