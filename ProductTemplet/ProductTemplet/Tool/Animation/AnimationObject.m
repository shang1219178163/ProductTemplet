...
-(void)animateTransition:(id < UIViewControllerContextTransitioning >)transitionContext{
    ...
    if (CGRectEqualToRect(CGRectZero, _circleCenterRect)) {
        _circleCenterRect = CGRectMake(kScreen_width/2.0, kScreen_height/2.0, 1, 1);
    ...
    //找出到页面4个角最长的半径
    CGFloat r1 = MAX(kScreen_width - centerX, centerX);
    CGFloat r2 = MAX(kScreen_height - centerY, centerY);
