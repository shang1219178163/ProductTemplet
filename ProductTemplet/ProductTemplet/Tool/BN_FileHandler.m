...
#import "BN_FileHandler.h"

@interface BN_FileHandler ()


@end


@implementation BN_FileHandler
...
+(NSDictionary *)getfilterDictFileType:(NSString *)fileType pathPrefix:(NSString *)pathPrefix pathSuffix:(NSString *)pathSuffix{
    ...
    NSArray * array = [BN_FileHandler getFileNameListType:fileType dirPath:fullPath];
    if (array.count != 0){
