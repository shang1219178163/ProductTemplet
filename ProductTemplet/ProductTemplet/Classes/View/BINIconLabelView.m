...
-(instancetype)init{
    ...
    if (self) {
        ...
        UILabel * labelTitle = [self createLabelWithRect:CGRectZero text:@"" textColor:nil tag:kTAG_LABEL patternType:@"1" font:KFZ_Third backgroudColor:nil alignment:NSTextAlignmentLeft];
...
//        self.imgView.layer.borderWidth = kW_LayerBorderWidth;
//        self.labelTitle.layer.borderColor = [UIColor orangeColor].CGColor;
//        self.labelTitle.layer.borderWidth = kW_LayerBorderWidth;
//        
