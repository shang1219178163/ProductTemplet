...
-(UILabel *)labelSix{
    if (!_labelSix) {
        _labelSix = [UILabel createLabelWithRect:CGRectZero text:@"" textColor:nil tag:kTAG_LABEL+5 patternType:@"0" font:KFZ_Third backgroudColor:[UIColor whiteColor] alignment:NSTextAlignmentCenter];
    }
    return _labelSix;
}
