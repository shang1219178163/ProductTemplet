...
@property (nonatomic, strong) NNButton *button6;
...
- (void)viewDidLayoutSubviews{
    ...
    self.button1.frame = CGRectMake(20, CGRectGetMaxY(self.button.frame) + 20, 100, 35);
    ...
    self.button4.frame = CGRectMake(20, CGRectGetMaxY(self.button3.frame) + 20, 100, 35*2);
    self.button5.frame = CGRectMake(20, CGRectGetMaxY(self.button4.frame) + 20, 75, 75);
    self.button6.frame = CGRectMake(20, CGRectGetMaxY(self.button5.frame) + 20, 100, 35);

}

#pragma mark -funtions

- (void)handleActionChoose:(UIButton *)sender {
...
//        _button1.layer.borderWidth = 1;
        ...
        _button1.direction = NNButtonDirectionLeft;
...
- (NNButton *)button2{
    if (!_button2) {
        ...
        _button2.direction = NNButtonDirectionRight;
...
- (NNButton *)button3{
    if (!_button3) {
        ...
        _button3.direction = NNButtonDirectionTop;
...
- (NNButton *)button4{
    if (!_button4) {
        ...
        _button4.direction = NNButtonDirectionBom;
