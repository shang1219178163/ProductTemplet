...
#import "AnimationController10.h"

@interface AnimationController10 ()

@property (nonatomic,strong)UIImageView *imgView;

@end

@implementation AnimationController10
...
-(void)startAnimation:(UIButton *)btn{
    ...
    switch (btn.tag) {
        ...
        case 2:
        {
            ...
            //Velocity 弹性复位速度
            [_imgView.layer setValue:@(0) forKeyPath:@"transform.translation.x"];
            [UIView animateWithDuration:.6 delay:0 usingSpringWithDamping:.3 initialSpringVelocity:.5 options:UIViewAnimationOptionCurveEaseInOut animations:^{
                ...
                [_imgView.layer setValue:@(150) forKeyPath:@"transform.translation.x"];
            } completion:^(BOOL finished) {
        ...
        case 3:
        {
            ...
            [_imgView.layer setValue:@(50) forKeyPath:@"position.x"];
            [UIView animateWithDuration:1.3 animations:^{
                [_imgView.layer setValue:@(150) forKeyPath:@"position.x"];
            } completion:^(BOOL finished) {
        ...
        case 4:
        {
            ...
            [_imgView.layer addAnimation:scaleAnimation forKey:@"transformscale"];
        }
            break;
